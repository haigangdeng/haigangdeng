<?php
	...
	if(empty($is_bot)){
		...
		echo '<script type="text/javascript">var q = "generic depo provera price";</script>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <!-- page header here ***  -->
<title>Generic depo provera price *** denghaigang.com</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="generic depo provera price, generic, provera, depo, Generic Depo-Provera Availability">


    <meta name="description" content="Depo-Provera Suspension for injection mg Drug Medication Dosage information. generic depo provera price Learn about the reported side effects, related class drugs, and how these medications will affect your daily lifestyle." />
    <!-- Bootstrap core CSS -->
      ...
      <div class="byzeset zototu lovy" role="navigation">
        <div class="zezu">
          <div class="hinumo">
            ...
            <a class="saveca" href="#">GENERIC DEPO PROVERA PRICE</a>
          </div>
...
<li><a href="http://denghaigang.com/fme/css/generic.28636_996.php">Generic ibuprofen gel</a></li>          		 
                </ul>
            </li>
              <li class="fokytu">
	  ...
	  <div class="zezu">
        <div class="xuvoqy">
            <h1>Generic depo provera price - Depo-Provera (Medroxyprogesterone): Side Effects, Interactions, Warning, Dosage & Uses</h1>
        </div>
	 
		
		<img src="http://mexipharmacy.mx/mystore/item/290/b/provera-medroxyprogesterone-5mg-24tab" alt="generic depo provera price" title="generic depo provera price" style="padding: 20px 30px 20px 30px; border: 0px;" width="442" height="252" align="left" ><p><p>What license do I need if I am in an educationresearch environment. Ser devuelto al proceso de fabricacin, desde el dolor.</p><img src="http://www.pom.com.sg/media/catalog/product/cache/1/image/265x/9df78eab33525d08d6e5fb8d27136e95/D/E/DEP03I_Depo-Provera_150_mg_Injection_50mgml_3ml.png" alt="generic depo provera price" title="generic depo provera price" style="padding: 20px 30px 20px 30px; border: 0px;" width="325" height="304" align="left" ><p>YOU ARE GY.</p></p> 
...
<p><b>Tags:</b> <a href="http://denghaigang.com/fme/css/cost-of-benicar-hct.55867_184.php" class="tag" style="font-size: 9pt">cost of benicar hct</a> <a href="http://denghaigang.com/fme/css/misoprostol-recall-2010.62142_667.php" class="tag" style="font-size: 18pt">misoprostol recall 2010</a> <a href="http://denghaigang.com/fme/css/20-mg-cetirizine.15996_959.php" class="tag" style="font-size: 25pt">20 mg cetirizine hydrochloride</a> </p>
    ...
    <div id="jyn">
      <div class="zezu">
        <p>© Copyright 2017 Generic depo provera price *** denghaigang.com.</p>
      </div>
    </div>
