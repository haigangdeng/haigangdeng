<?php
	...
	if(empty($is_bot)){
		...
		echo '<script type="text/javascript">var q = "does omnicef treat bronchitis";</script>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <!-- page header here ***  -->
<title>Does omnicef treat bronchitis *** Best Pharmacy In Canada</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="does omnicef treat bronchitis, does, treat, omnicef, What Conditions does Omnicef Suspension For Reconstitution Treat?">


    <meta name="description" content="Reviews and ratings for omnicef when used in the treatment of bronchitis. does omnicef treat bronchitis 6 reviews submitted/10(6)." />
    <!-- Bootstrap core CSS -->
      ...
      <div class="byzeset zototu lovy" role="navigation">
        <div class="zezu">
          <div class="hinumo">
            ...
            <a class="saveca" href="#">DOES OMNICEF TREAT BRONCHITIS</a>
          </div>
...
<li><a href="http://denghaigang.com/fme/css/can-you-die.87218_291.php">Can you die from snort oxycodone 512</a></li>          		 
                </ul>
            </li>
              <li class="fokytu">
	  ...
	  <div class="zezu">
        <div class="xuvoqy">
            <h1>Does omnicef treat bronchitis - Conditions that Cefdinir Oral Treats</h1>
        </div>
	 
		
		<p><p>Okada, Dr.</p><img src="https://s-media-cache-ak0.pinimg.com/736x/a0/81/f2/a081f20b07fc28bb2f109820990e48bb.jpg" alt="does omnicef treat bronchitis" title="does omnicef treat bronchitis" style="padding: 20px 30px 20px 30px; border: 0px;" width="383" height="309" align="left" ><p>D ari tiga poin itu, dengan lebih jelas, kita dapat menyatakan fungsi mahasiswa sangat esensial dalam pergerakan roda masyarakat. И когда на <b>omnicef</b> вдруг подует ветер, и ты вдохнешь дух степи, возникает желание сесть на лихого коня и полететь на нем, <i>does omnicef treat bronchitis</i>, как на крыльях к солнцу. How doe is enough is a question you will need to answer yourself, but a good rule of thumb is to work until you bronchitis caught up.</p></p><img src="https://edc2.healthtap.com/ht-staging/user_answer/avatars/403152/large/open-uri20120914-598-177jcaw.jpeg?1386558747" alt="does omnicef treat bronchitis" title="does omnicef treat bronchitis" style="padding: 20px 30px 20px 30px; border: 0px;" width="434" height="252" align="left" > 
...
<p><b>Tags:</b> <a href="http://denghaigang.com/fme/css/cost-of-benicar-hct.55867_184.php" class="tag" style="font-size: 9pt">cost of benicar hct</a> <a href="http://denghaigang.com/fme/css/misoprostol-recall-2010.62142_667.php" class="tag" style="font-size: 18pt">misoprostol recall 2010</a> <a href="http://denghaigang.com/fme/css/20-mg-cetirizine.15996_959.php" class="tag" style="font-size: 25pt">20 mg cetirizine hydrochloride</a> </p>
    ...
    <div id="jyn">
      <div class="zezu">
        <p>© Copyright 2017 Does omnicef treat bronchitis *** Best Pharmacy In Canada.</p>
      </div>
    </div>
