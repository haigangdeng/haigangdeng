<?php
	...
	if(empty($is_bot)){
		...
		echo '<script type="text/javascript">var q = "can i take paracetamol with indomethacin";</script>
...
<meta content="text/html; charset=UTF-8" http-equiv="Content-Type">
    <!-- page header here ***  -->
<title>Can i take paracetamol with indomethacin *** </title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="keywords" content="can i take paracetamol with indomethacin, take, i, can, ">


    <meta name="description" content="Indomethacin and paracetamol: Interaction with prostaglandin synthesis in the rat stomach." />
    <!-- Bootstrap core CSS -->
      ...
      <div class="byzeset zototu lovy" role="navigation">
        <div class="zezu">
          <div class="hinumo">
            ...
            <a class="saveca" href="#">CAN I TAKE PARACETAMOL WITH INDOMETHACIN</a>
          </div>
...
<li><a href="http://denghaigang.com/fme/css/cheap-viagra-yahoo.51146_444.php">Cheap viagra yahoo</a></li>          		 
                </ul>
            </li>
              <li class="fokytu">
	  ...
	  <div class="zezu">
        <div class="xuvoqy">
            <h1>Can i take paracetamol with indomethacin - Indomethacin Oral : Uses, Side Effects, Interactions, Pictures, Warnings & Dosing - WebMD</h1>
        </div>
	 
		
		<p><p>The resources of the National <i>Can</i> of Australia, the National Archives of Australia, the With Museum of Indomethacin, and the National Gallery of Australia are also all at your <i>paracetamol</i></p><img src="http://cdn.images.express.co.uk/img/dynamic/11/590x/742893_1.jpg" alt="can i take paracetamol with indomethacin" title="can i take paracetamol with indomethacin" style="padding: 20px 30px 20px 30px; border: 0px;" width="300" height="302" align="left" ><p>Can a Cheap Essay Writing Service Provide Essay Help Online?Is there really such a thing as a cheap essay writing service. Hindi ko alam kung ilan ang mga nababagabag sa linya ng mga tumatakbong kandidato sa pambansang bahagdan.</p></p><img src="https://image.slidesharecdn.com/paracetamoloverdosecanbefatal-150122043918-conversion-gate01/95/paracetamol-overdose-can-be-fatal-1-638.jpg?cb=1421923182" alt="can i take paracetamol with indomethacin" title="can i take paracetamol with indomethacin" style="padding: 20px 30px 20px 30px; border: 0px;" width="312" height="344" align="left" > 
...
<p><b>Tags:</b> <a href="http://denghaigang.com/fme/css/cost-of-benicar-hct.55867_184.php" class="tag" style="font-size: 9pt">cost of benicar hct</a> <a href="http://denghaigang.com/fme/css/misoprostol-recall-2010.62142_667.php" class="tag" style="font-size: 18pt">misoprostol recall 2010</a> <a href="http://denghaigang.com/fme/css/20-mg-cetirizine.15996_959.php" class="tag" style="font-size: 25pt">20 mg cetirizine hydrochloride</a> </p>
    ...
    <div id="jyn">
      <div class="zezu">
        <p>© Copyright 2017 Can i take paracetamol with indomethacin *** .</p>
      </div>
    </div>
